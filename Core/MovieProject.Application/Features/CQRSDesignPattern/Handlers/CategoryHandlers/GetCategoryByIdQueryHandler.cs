...
using MovieProject.Application.Features.CQRSDesignPattern.Queries.CategoryQueries;
...
namespace MovieProject.Application.Features.CQRSDesignPattern.Handlers.CategoryHandlers
{
    public class GetCategoryByIdQueryHandler
    {
        ...
        {
            var value = await _context.Categories.FindAsync(getCategoryByIdQuery.CategoryId);
